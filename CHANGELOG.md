...
- Add a Dependabot auto-merge workflow for same-repository GitHub Actions and Docker patch/minor
  updates, while keeping major updates, npm/pnpm updates, and Docker runtime baseline jumps manual.
