...
| `alias_set_enabled`        | aliases        | write, non-destructive, idempotent, open-world     | single alias state mutation           | { enabled }                                                  |
...
| `contact_set_blocked`      | contacts       | write, non-destructive, idempotent, open-world     | single contact state mutation         | { block_forward }                                            |
...
| `custom_domain_trash_list` | custom_domains | read-only, non-destructive, idempotent, open-world | limit, defaults to 100, max 500       | { aliases, returned, total, truncated }                      |
